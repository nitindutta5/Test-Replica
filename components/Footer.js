            ...
            <Row className="py-5" >
                    ...
                    <Col lg="2" xs="8"  className={"ms-lg-auto order-2 order-lg-4 "+[styles.social]}  >
                        ...
                        <div className="sociallink-packet">
                            ...
                            <div className="s-icon">
                                <a rel="noreferrer" href="https://www.facebook.com/arttdinox" target="_blank">
                            ...
                            <div className="s-icon">
                                <a rel="noreferrer" href="https://www.instagram.com/arttdinox/" target="_blank">
                            ...
                            <div className="s-icon">
                                <a rel="noreferrer" href="https://www.youtube.com/channel/UC_7JllBs_KA_mepneBZouUg" target="_blank">
