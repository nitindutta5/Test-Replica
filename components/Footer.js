                    ...
                    <Col lg="2" className="ms-lg-auto"  >
                        ...
                        <div className="sociallink-packet">
                            <div className="s-icon">
                                <a href="https://www.linkedin.com/in/jindal-stainless-lifestyle-limited-b14792197/" target="_blank">
                            ...
                            <div className="s-icon">
                                <a href="https://twitter.com/jsll_ve" target="_blank">
                            ...
                            <div className="s-icon">
                                <a href="https://www.facebook.com/JSLL-Value-Engineering-101958765095741/" target="_blank">
                            ...
                            <div className="s-icon">
                                <a href="https://www.instagram.com/jindalstainless/?hl=en" target="_blank">
                            ...
                            <div className="s-icon">
                                <a href="https://www.youtube.com/channel/UCx_m3nHhT2g8zE7za_aO-Wg" target="_blank">
